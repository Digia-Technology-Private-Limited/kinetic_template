  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: store.isLoading
          ? const LoadingState()
          : RefreshIndicator(
              onRefresh: () => context.read<StoreProvider>().loadHomePageData(),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.search, color: AppColors.black100),
                    ...
                    ...store.collections.map((col) {
                      if (col.products.isEmpty) return const SizedBox.shrink();
